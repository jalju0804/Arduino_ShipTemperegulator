...
#define  HEATER_MIN_TEMP_LEVEL		-55.0+HEATER_TEMP_DIFFERENCE	// Registance :  200 (-35도) ohm ???? 2022 06 22 -60도
...
#define  HEATER_ONN_TEMP_LEVEL		40.0+HEATER_TEMP_DIFFERENCE
//#define  HEATER_OFF_TEMP_LEVEL		45.0+HEATER_TEMP_DIFFERENCE
#define  HEATER_OFF_TEMP_LEVEL		50.0+HEATER_TEMP_DIFFERENCE
